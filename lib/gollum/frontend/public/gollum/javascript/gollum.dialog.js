  ...
  var Dialog = {
      ...
      for ( var i=0; i < fieldArray.length; i++ ) {
        if ( typeof fieldArray[i] == 'object' ) {
          ...
          case 'text':
            ...
            break;
          case 'checkbox':
            fieldMarkup += Dialog.createCheckbox( fieldArray[i] );
            break;
    ...
    createFieldText: function( fieldAttributes ) {
      ...
      if ( fieldAttributes.name ) {
        html += Dialog.createLabel( fieldAttributes.name, fieldAttributes.id );
      }
    ...
    createCheckbox: function( fieldAttributes ) {
      var html = '';
    ...
    eventOK: function( e, evtOK ) {
      ...
      $('#gollum-dialog-dialog-body input:text').each(function() {
        results[$(this).attr('name')] = $(this).val();
      });
      $('#gollum-dialog-dialog-body input:checkbox').each(function() {
        results[$(this).attr('name')] = $(this + ':checked').val();
      });
